...
//
//------------------------------------------------------------------------------
// $Id: bmi_shared_lib_fortran_api.c 6568 2016-09-19 12:59:26Z noort $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/deltares_common/packages/deltares_common_c/src/bmi_shared_lib_fortran_api.c $
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
