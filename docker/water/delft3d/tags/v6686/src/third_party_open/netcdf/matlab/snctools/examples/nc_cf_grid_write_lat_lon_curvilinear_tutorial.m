...
%% Define meta-info: global
   ...
   OPT.history                = ['tranformation to netCDF: $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/third_party_open/netcdf/matlab/snctools/examples/nc_cf_grid_write_lat_lon_curvilinear_tutorial.m $'];
