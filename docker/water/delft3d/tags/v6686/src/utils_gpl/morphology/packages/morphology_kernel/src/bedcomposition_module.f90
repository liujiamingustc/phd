...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: bedcomposition_module.f90 6086 2016-04-28 12:50:25Z jagers $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_gpl/morphology/packages/morphology_kernel/src/bedcomposition_module.f90 $
!!--module description----------------------------------------------------------
!
...
subroutine bedcomposition_module_info(messages)
    ...
    !
    call addmessage(messages,'$Id: bedcomposition_module.f90 6086 2016-04-28 12:50:25Z jagers $')
    call addmessage(messages,'$URL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_gpl/morphology/packages/morphology_kernel/src/bedcomposition_module.f90 $')
