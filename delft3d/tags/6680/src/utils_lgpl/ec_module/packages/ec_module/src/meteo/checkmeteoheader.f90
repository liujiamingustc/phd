...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: checkmeteoheader.f90 6018 2016-04-15 11:41:55Z ye $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/ec_module/packages/ec_module/src/meteo/checkmeteoheader.f90 $
!!--description-----------------------------------------------------------------
! NONE
