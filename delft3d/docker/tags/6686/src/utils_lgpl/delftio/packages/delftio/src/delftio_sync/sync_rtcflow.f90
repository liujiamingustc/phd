...
!                                                                               
!-------------------------------------------------------------------------------
!  $Id: sync_rtcflow.f90 6179 2016-06-08 09:28:42Z jagers $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/delftio/packages/delftio/src/delftio_sync/sync_rtcflow.f90 $
!!--description-----------------------------------------------------------------
