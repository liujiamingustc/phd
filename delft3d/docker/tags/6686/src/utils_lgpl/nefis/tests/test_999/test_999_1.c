...
//
//------------------------------------------------------------------------------
// $Id: test_999_1.c 5717 2016-01-12 11:35:24Z mourits $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/nefis/tests/test_999/test_999_1.c $
#include <stdio.h>
#include <string.h>
#include "nefis.h"
int main()
