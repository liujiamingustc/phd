...
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/deltares_common/packages/deltares_common/src/string_module.f90 $
!!--description-----------------------------------------------------------------
!
...
!!--declarations----------------------------------------------------------------
   ...
   contains
      ...
      subroutine string_module_info(messages)
          ...
          call addmessage(messages,'$URL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/deltares_common/packages/deltares_common/src/string_module.f90 $')
