...
//
//------------------------------------------------------------------------------
// $Id: cutil.c 6430 2016-08-11 19:21:39Z dam_ar $
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/tags/6686/src/utils_lgpl/deltares_common/packages/deltares_common_c/src/cutil.c $
//------------------------------------------------------------------------------*/
//  Delft3D - C Utilities
